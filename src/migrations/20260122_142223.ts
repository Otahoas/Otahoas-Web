...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_calendar_embed_language" AS ENUM('fi', 'en');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_calendar_embed_language" AS ENUM('fi', 'en');
  ...
  CREATE TYPE "public"."enum_reservation_targets_category" AS ENUM('club-room', 'workshop', 'music-room', 'storage', 'equipment');
  CREATE TYPE "public"."enum_access_request_submissions_email_status" AS ENUM('pending', 'sent', 'failed');
  ...
  CREATE TABLE "pages_blocks_calendar_embed" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "pages_blocks_access_request_form" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	...
  	"intro_content" jsonb,
  	"rules_page_link" varchar,
  	"spaces_info_link" varchar,
  	"calendar_link" varchar,
  	"confirmation_message" jsonb,
  	"block_name" varchar
  );
  
  CREATE TABLE "pages_blocks_committee_members" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "pages_blocks_committee" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "pages_blocks_contact_info_telegram_channels" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_calendar_embed" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_access_request_form" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_committee_members" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_committee" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_contact_info_telegram_channels" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "reservation_targets" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"email_prefix" varchar NOT NULL,
  	"telegram_topic_id" varchar DEFAULT '1',
  	"label_fi" varchar NOT NULL,
  	"label_en" varchar NOT NULL,
  	"category" "enum_reservation_targets_category" NOT NULL,
  ...
  CREATE TABLE "access_request_submissions" (
  	"id" serial PRIMARY KEY NOT NULL,
  	...
  	"email_status" "enum_access_request_submissions_email_status" DEFAULT 'pending',
  ...
  CREATE TABLE "payload_locked_documents_rels" (
  	...
  	"categories_id" integer,
  	"users_id" integer,
  	"reservation_targets_id" integer,
  	"access_request_submissions_id" integer,
  ...
  CREATE TABLE "header" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"logo_id" integer,
  	"logo_size" numeric DEFAULT 48,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  
  CREATE TABLE "header_locales" (
  	"site_title" varchar DEFAULT 'OtaHoas',
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  );
  ...
  ALTER TABLE "pages_blocks_calendar_embed" ADD CONSTRAINT "pages_blocks_calendar_embed_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_access_request_form" ADD CONSTRAINT "pages_blocks_access_request_form_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_committee_members" ADD CONSTRAINT "pages_blocks_committee_members_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pages_blocks_committee_members" ADD CONSTRAINT "pages_blocks_committee_members_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_committee"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_committee" ADD CONSTRAINT "pages_blocks_committee_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_calendar_embed" ADD CONSTRAINT "_pages_v_blocks_calendar_embed_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_access_request_form" ADD CONSTRAINT "_pages_v_blocks_access_request_form_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_committee_members" ADD CONSTRAINT "_pages_v_blocks_committee_members_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_committee_members" ADD CONSTRAINT "_pages_v_blocks_committee_members_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_committee"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_committee" ADD CONSTRAINT "_pages_v_blocks_committee_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "access_request_submissions" ADD CONSTRAINT "access_request_submissions_target_id_reservation_targets_id_fk" FOREIGN KEY ("target_id") REFERENCES "public"."reservation_targets"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_reservation_targets_fk" FOREIGN KEY ("reservation_targets_id") REFERENCES "public"."reservation_targets"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_access_request_submissions_fk" FOREIGN KEY ("access_request_submissions_id") REFERENCES "public"."access_request_submissions"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_calendar_embed_order_idx" ON "pages_blocks_calendar_embed" USING btree ("_order");
  CREATE INDEX "pages_blocks_calendar_embed_parent_id_idx" ON "pages_blocks_calendar_embed" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_calendar_embed_path_idx" ON "pages_blocks_calendar_embed" USING btree ("_path");
  CREATE INDEX "pages_blocks_calendar_embed_locale_idx" ON "pages_blocks_calendar_embed" USING btree ("_locale");
  CREATE INDEX "pages_blocks_access_request_form_order_idx" ON "pages_blocks_access_request_form" USING btree ("_order");
  CREATE INDEX "pages_blocks_access_request_form_parent_id_idx" ON "pages_blocks_access_request_form" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_access_request_form_path_idx" ON "pages_blocks_access_request_form" USING btree ("_path");
  CREATE INDEX "pages_blocks_access_request_form_locale_idx" ON "pages_blocks_access_request_form" USING btree ("_locale");
  CREATE INDEX "pages_blocks_committee_members_order_idx" ON "pages_blocks_committee_members" USING btree ("_order");
  CREATE INDEX "pages_blocks_committee_members_parent_id_idx" ON "pages_blocks_committee_members" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_committee_members_locale_idx" ON "pages_blocks_committee_members" USING btree ("_locale");
  CREATE INDEX "pages_blocks_committee_members_image_idx" ON "pages_blocks_committee_members" USING btree ("image_id");
  CREATE INDEX "pages_blocks_committee_order_idx" ON "pages_blocks_committee" USING btree ("_order");
  CREATE INDEX "pages_blocks_committee_parent_id_idx" ON "pages_blocks_committee" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_committee_path_idx" ON "pages_blocks_committee" USING btree ("_path");
  ...
  CREATE INDEX "_pages_v_blocks_calendar_embed_order_idx" ON "_pages_v_blocks_calendar_embed" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_calendar_embed_parent_id_idx" ON "_pages_v_blocks_calendar_embed" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_calendar_embed_path_idx" ON "_pages_v_blocks_calendar_embed" USING btree ("_path");
  CREATE INDEX "_pages_v_blocks_calendar_embed_locale_idx" ON "_pages_v_blocks_calendar_embed" USING btree ("_locale");
  CREATE INDEX "_pages_v_blocks_access_request_form_order_idx" ON "_pages_v_blocks_access_request_form" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_access_request_form_parent_id_idx" ON "_pages_v_blocks_access_request_form" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_access_request_form_path_idx" ON "_pages_v_blocks_access_request_form" USING btree ("_path");
  CREATE INDEX "_pages_v_blocks_access_request_form_locale_idx" ON "_pages_v_blocks_access_request_form" USING btree ("_locale");
  CREATE INDEX "_pages_v_blocks_committee_members_order_idx" ON "_pages_v_blocks_committee_members" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_committee_members_parent_id_idx" ON "_pages_v_blocks_committee_members" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_committee_members_locale_idx" ON "_pages_v_blocks_committee_members" USING btree ("_locale");
  CREATE INDEX "_pages_v_blocks_committee_members_image_idx" ON "_pages_v_blocks_committee_members" USING btree ("image_id");
  CREATE INDEX "_pages_v_blocks_committee_order_idx" ON "_pages_v_blocks_committee" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_committee_parent_id_idx" ON "_pages_v_blocks_committee" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_committee_path_idx" ON "_pages_v_blocks_committee" USING btree ("_path");
  ...
  CREATE UNIQUE INDEX "reservation_targets_email_prefix_idx" ON "reservation_targets" USING btree ("email_prefix");
  CREATE INDEX "reservation_targets_updated_at_idx" ON "reservation_targets" USING btree ("updated_at");
  CREATE INDEX "reservation_targets_created_at_idx" ON "reservation_targets" USING btree ("created_at");
  CREATE INDEX "access_request_submissions_target_idx" ON "access_request_submissions" USING btree ("target_id");
  CREATE INDEX "access_request_submissions_updated_at_idx" ON "access_request_submissions" USING btree ("updated_at");
  CREATE INDEX "access_request_submissions_created_at_idx" ON "access_request_submissions" USING btree ("created_at");
  ...
  CREATE INDEX "payload_locked_documents_rels_reservation_targets_id_idx" ON "payload_locked_documents_rels" USING btree ("reservation_targets_id");
  CREATE INDEX "payload_locked_documents_rels_access_request_submissions_idx" ON "payload_locked_documents_rels" USING btree ("access_request_submissions_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_calendar_embed" CASCADE;
  DROP TABLE "pages_blocks_access_request_form" CASCADE;
  DROP TABLE "pages_blocks_committee_members" CASCADE;
  DROP TABLE "pages_blocks_committee" CASCADE;
  DROP TABLE "pages_blocks_contact_info_telegram_channels" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_calendar_embed" CASCADE;
  DROP TABLE "_pages_v_blocks_access_request_form" CASCADE;
  DROP TABLE "_pages_v_blocks_committee_members" CASCADE;
  DROP TABLE "_pages_v_blocks_committee" CASCADE;
  DROP TABLE "_pages_v_blocks_contact_info_telegram_channels" CASCADE;
  ...
  DROP TABLE "reservation_targets" CASCADE;
  DROP TABLE "access_request_submissions" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_calendar_embed_language";
  DROP TYPE "public"."enum_pages_blocks_access_request_form_language";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_calendar_embed_language";
  DROP TYPE "public"."enum__pages_v_blocks_access_request_form_language";
  ...
  DROP TYPE "public"."enum_reservation_targets_category";
  DROP TYPE "public"."enum_access_request_submissions_email_status";
