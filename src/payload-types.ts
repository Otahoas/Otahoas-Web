...
export interface Config {
  ...
  collections: {
    ...
    categories: Category;
    users: User;
    'reservation-targets': ReservationTarget;
    'access-request-submissions': AccessRequestSubmission;
    redirects: Redirect;
    forms: Form;
  ...
  collectionsSelect: {
    ...
    'reservation-targets': ReservationTargetsSelect<false> | ReservationTargetsSelect<true>;
    'access-request-submissions': AccessRequestSubmissionsSelect<false> | AccessRequestSubmissionsSelect<true>;
...
export interface ReservationTarget {
  id: number;
  /**
   * Unique identifier for this target (e.g., "jmt10cd")
   */
  emailPrefix: string;
  /**
  ...
  /**
   * Label shown in Finnish dropdown
   */
  labelFi: string;
  /**
   * Label shown in English dropdown
   */
  labelEn: string;
  category: 'club-room' | 'workshop' | 'music-room' | 'storage' | 'equipment';
  /**
   * If unchecked, this target will not appear in the dropdown
   */
  active?: boolean | null;
  /**
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "access-request-submissions".
 */
export interface AccessRequestSubmission {
  id: number;
  /**
   * The reservation target this request is for
   */
  target: number | ReservationTarget;
  submitterName: string;
  submitterEmail: string;
  /**
   * Full form data as submitted
   */
  requestData:
    | {
        [k: string]: unknown;
    ...
    | null;
  /**
   * Where the notification was sent (Telegram topic ID)
   */
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        ...
        value: number | ReservationTarget;
      } | null)
    | ({
        relationTo: 'access-request-submissions';
        value: number | AccessRequestSubmission;
      } | null)
    | ({
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "reservation-targets_select".
 */
export interface ReservationTargetsSelect<T extends boolean = true> {
  emailPrefix?: T;
  telegramTopicId?: T;
  labelFi?: T;
  labelEn?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "access-request-submissions_select".
 */
export interface AccessRequestSubmissionsSelect<T extends boolean = true> {
  target?: T;
  submitterName?: T;
  submitterEmail?: T;
  requestData?: T;
  notificationSentTo?: T;
  sentAt?: T;
  emailStatus?: T;
  errorMessage?: T;
  updatedAt?: T;
...
export interface Header {
  ...
  /**
   * Logo size in pixels (24-128)
   */
  logoSize?: number | null;
  /**
   * Site title shown next to logo
   */
